...
// across the brand, even though here it's a user preference (Light/Dark/
// System) rather than tied to actual night-service business hours.
export const DARK_THEME: CustomerTheme = {
  primary: colors.primary,
...
export function getCustomerTheme(isDark: boolean): CustomerTheme {
  return isDark ? DARK_THEME : COLORS;
}
